...
public:
    ...
    crow::response createReservation(const crow::request& req, int user_id, int pet_id, int doctor_id, std::string date, std::string time_slot, std::string status);                 //  对应 /api/reservate/record
    crow::response getReservations(const crow::request& req, int user_id);                   //  对应 /api/reservate/getrecord
    crow::response updateReservation(const crow::request& req, int user_id, int id);
