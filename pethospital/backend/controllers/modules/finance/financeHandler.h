...
public:
    ...
    crow::response getSalaryManagementData(const crow::request &req); // 获取工资管理页数据 对应 /api/finance/getSalaryManagementData

    crow::response changeSalary(const crow::request &req); // 修改员工工资 对应 /api/finance/changeSalary
};
#endif
