...
public:
    ...
    crow::response userUpdate(const crow::request& req, int authenticatedUserId = -1); // 对应注册 "/api/user/register" 与更新资料 "/api/user/profile"
    ...
    crow::response deleteReservation(const crow::request& req, int userId, int reservationId);         // 对应 DELETE /api/user/reservations/<id>
