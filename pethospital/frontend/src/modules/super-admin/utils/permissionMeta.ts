...
export const PERMISSION_META: Record<string, PermissionMeta> = {
  ...
  "salary:review": { group: "薪资与股份", label: "工资初审", desc: "完成员工工资行财务初审（不含提交主管）。", danger: true },
  "salary:submit-review": { group: "薪资与股份", label: "提交主管复审", desc: "将完成初审的工资周期提交给主管。", danger: true },
  "salary:supervisor-review": { group: "薪资与股份", label: "主管复审", desc: "主管批准或退回工资周期。", danger: true },
  "salary:lock": { group: "薪资与股份", label: "锁定工资周期", desc: "在主管批准后锁定工资周期。", danger: true },
