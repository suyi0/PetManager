...
export default defineComponent({
  ...
  setup() {
    ...
    const salaryManagement = computed(
      () => store.state.superAdmin.salaryManagement
    );
    ...
    const ensureSalaryData = async () => {
      await store.dispatch("superAdmin/ensureSalaryManagement");
    ...
    const refreshSalaryData = async () => {
      await store.dispatch("superAdmin/refreshSalaryManagement");
    ...
    const saveSalary = async () => {
      ...
      saving.value = true;
      try {
        await superAdminApi.changeSalary({
        ...
        store.commit("superAdmin/markSalaryManagementDirty");
