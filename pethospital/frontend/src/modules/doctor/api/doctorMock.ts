...
export const doctorWorkbenchStats: DoctorStat[] = [
  ...
  { label: "今日预约", value: 8, hint: "预约成功 + 已到院" },
...
export const reservationItemsMock: ReservationItem[] = [
  {
    ...
    pet_id: 11,
    pet_name: "团子",
    reservation_type: "肠胃检查",
    date: "2026-03-10",
    time_slot: "14:00",
    schedule: "2026-03-10 14:00",
    status: "预约成功",
    created_at: "2026-03-09 09:20",
    price: 0,
  },
  {
    id: 102,
    ...
    pet_id: 12,
    pet_name: "糯米",
    reservation_type: "免疫复诊",
    date: "2026-03-10",
    time_slot: "15:30",
    schedule: "2026-03-10 15:30",
    status: "预约成功",
    created_at: "2026-03-09 10:05",
    price: 0,
  },
  {
    id: 103,
    ...
    pet_id: 13,
    pet_name: "小七",
    reservation_type: "呼吸道复查",
    date: "2026-03-10",
    time_slot: "16:10",
    schedule: "2026-03-10 16:10",
    status: "已到院",
    created_at: "2026-03-09 11:40",
    price: 0,
  },
];
